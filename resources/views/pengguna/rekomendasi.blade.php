  ...
  <header id="header" class="header d-flex align-items-center">
    ...
    <section id="rekomendasi" class="rekomendasi">
        <div class="container" data-aos="fade-up">
          ...
          <form action="/proses-rekomendasi" method="POST" class="php-email-form">
            <div class="row">
              <div class="col-md-6 form-group">
                <label for="nama">Jenis Obat</label>
                <input type="text" name="nama" id="nama" class="form-control" placeholder="Jenis Obat" required>
              </div>
      
            <div class="form-group mt-3">
              <label for="gejala">Gejala</label>
              <textarea name="gejala" id="gejala" rows="5" class="form-control" placeholder="Deskripsikan gejala Anda..." required></textarea>
            </div>
      
            <div class="form-group mt-3">
              <label for="usia">Usia</label>
              <input type="number" name="usia" id="usia" class="form-control" placeholder="Usia Anda" required>
            </div>
